(module
	...
	(func $indexForPartition (param $x i32) (param $y i32) (result i32)
		(i32.add
			(i32.mul
				(i32.const 8)
				(get_local $y)
		...
		(block (result i32)
			(i32.and
				...
				(i32.and
					...
					(i32.eq (get_local $target) (i32.const 0)) ;; target must unoccupied
				)
			)
		)
		(then
...
(func $initBoard
	;; Placethe white pieces a the top of the board
	...
	(call $setTurnOwner (i32.const 1)) ;; Blacks go first
	)
